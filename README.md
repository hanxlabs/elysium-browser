...
- `POST /internal/v1/sites/login`：按 `app/site_login/service.py` 中注册的站点适配器执行一次登录。`audiences`、`pter`、`zmpt`、`qingwa`、`ubits`、`piggo`、`52movie`、`luckpt`、`hitpt` 暂时仅支持 Depiler，不在 Browser 网关注册。
