...
DEFINITION = SiteDefinition("nicept", "NicePT", ("www.nicept.net",), "www.nicept.net", image_captcha=True, challenge=True, two_factor_field="two_step_code")

class NiceptLoginAdapter(ConfiguredSiteLoginAdapter):
