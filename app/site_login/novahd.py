...
DEFINITION = SiteDefinition("novahd", "NovaHD", ("pt.novahd.top",), "pt.novahd.top", image_captcha=True, challenge=True, two_factor_field="two_step_code")

class NovahdLoginAdapter(ConfiguredSiteLoginAdapter):
